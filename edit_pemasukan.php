...
if (isset($_POST['update'])) {
    ...
    $sql = "UPDATE pemasukan SET tanggal='$tanggal', sumber='$sumber', jumlah='$jumlah' WHERE id_pemasukan= $id_pemasukan";
...
<head>
    ...
    <title>Perbarui Pemasukan Keuangan</title>
...
<body>
    ...
    <div class="container">
    <form action="edit_pemasukan.php?id_pemasukan=<?php echo $id_pemasukan;?>" method="POST" class="sign-in-form">
      <h4>Perbarui Pemasukan Keuangan</h4>
      ...
      <select name="sumber" class="form-select" type="select">
                ...
                <option value="Upah" <?php if ($sumber == "Upah") echo "selected"; ?>>Upah</option>
                <option value="Gaji" <?php if ($sumber == "Gaji") echo "selected"; ?>>Gaji</option>
                <option value="Bonus" <?php if ($sumber == "Bonus") echo "selected"; ?>>Bonus</option>
                <option value="Investasi" <?php if ($sumber == "Investasi") echo "selected"; ?>>Investasi</option>
                <option value="Penjualan" <?php if ($sumber == "Penjualan") echo "selected"; ?>>Penjualan</option>
                <option value="Pemberian" <?php if ($sumber == "Pemberian") echo "selected"; ?>>Pemberian</option>
      </select>
