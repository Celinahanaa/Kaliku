...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO pemasukan (id_user, tanggal, sumber, jumlah) VALUES ('$id_user', '$tanggal', '$sumber', '$jumlah')";
    if ($db->query($sql) === TRUE) {
        $register_message = "Data pemasukan berhasil dimasukkan";
    } else {
...
<body>
    ...
    <div class="container">
    <form action="pemasukan.php" method="POST" class="sign-in-form">
      <h4>Masukkan Pemasukan Keuangan</h4>
